...
Welcome to the `signalx` documentation index. `signalx` is a quantitative signal extraction library providing 239 standardized technical and statistical trading signals across 8 indicator families.
...
| [Signals Catalog](.ai/SIGNALS_CATALOG.md) | Full breakdown and trigger condition reference for all 239 trading signals. |
...
- **239 Standardized Signals**: Covers Trend (52), Momentum (39), Volatility (44), Volume (32), Candlestick (28), SMC (11), Statistical (20), Composite (13).
